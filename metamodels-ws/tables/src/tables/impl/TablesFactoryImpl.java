...
public class TablesFactoryImpl extends EFactoryImpl implements TablesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TablesPackage.ROW: return createRow();
			case TablesPackage.CELL: return createCell();
			case TablesPackage.COLUMN_GROUP: return createColumnGroup();
			case TablesPackage.COLUMN: return createColumn();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case TablesPackage.COLUMN_TYPE:
	...
	public ColumnGroup createColumnGroup() {
		ColumnGroupImpl columnGroup = new ColumnGroupImpl();
		return columnGroup;
	}
