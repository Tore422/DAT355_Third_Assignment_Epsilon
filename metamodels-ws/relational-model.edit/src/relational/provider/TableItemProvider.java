...
public class TableItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RelationalPackage.Literals.TABLE__PRIMARY_KEY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RelationalPackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(RelationalPackage.Literals.TABLE__CONSTRAINTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			...
			case RelationalPackage.TABLE__CONSTRAINTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.TABLE__COLUMNS,
				 RelationalFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.TABLE__CONSTRAINTS,
				 RelationalFactory.eINSTANCE.createForeignKeyConstraint()));
		...
		newChildDescriptors.add
			(createChildParameter
				(RelationalPackage.Literals.TABLE__CONSTRAINTS,
				 RelationalFactory.eINSTANCE.createPrimaryKeyConstraint()));
	}
