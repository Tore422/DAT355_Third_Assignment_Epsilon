 ...
 * @generated
 */
public class InputTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FlowchartParserProvider.getParser(FlowchartElementTypes.Input_2004, getParserElement(),
					FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.InputTextEditPart.VISUAL_ID));
		}
		return parser;
	}
