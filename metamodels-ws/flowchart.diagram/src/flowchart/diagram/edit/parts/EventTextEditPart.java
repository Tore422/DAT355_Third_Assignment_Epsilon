...
public class EventTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FlowchartParserProvider.getParser(FlowchartElementTypes.Event_2001, getParserElement(),
					FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.EventTextEditPart.VISUAL_ID));
		}
		return parser;
	}
