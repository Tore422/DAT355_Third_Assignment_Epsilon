 ...
 * @generated
 */
public class AssignmentTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssignmentTextEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new FlowchartTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FlowchartParserProvider.getParser(FlowchartElementTypes.Assignment_2002, getParserElement(),
					FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.AssignmentTextEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, FlowchartEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
