...
public class DecisionTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FlowchartParserProvider.getParser(FlowchartElementTypes.Decision_2003, getParserElement(),
					FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.DecisionTextEditPart.VISUAL_ID));
		}
		return parser;
	}
