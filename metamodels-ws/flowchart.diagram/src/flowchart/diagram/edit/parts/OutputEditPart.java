...
import flowchart.diagram.edit.policies.OutputItemSemanticEditPolicy;
...
public class OutputEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OutputTextEditPart) {
			((OutputTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureOutputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(FlowchartVisualIDRegistry.getType(OutputTextEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 210, 105, 30);
