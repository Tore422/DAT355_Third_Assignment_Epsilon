 ...
 * @generated
 */
public class OutputTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FlowchartParserProvider.getParser(FlowchartElementTypes.Output_2005, getParserElement(),
					FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.OutputTextEditPart.VISUAL_ID));
		}
		return parser;
	}
