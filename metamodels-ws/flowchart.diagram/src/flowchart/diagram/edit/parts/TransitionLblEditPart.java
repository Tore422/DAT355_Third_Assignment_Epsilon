 ...
 * @generated
 */
public class TransitionLblEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.TransitionLblEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public TransitionLblEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = FlowchartParserProvider.getParser(FlowchartElementTypes.Transition_4001, getParserElement(),
					FlowchartVisualIDRegistry.getType(flowchart.diagram.edit.parts.TransitionLblEditPart.VISUAL_ID));
		}
		return parser;
	}
