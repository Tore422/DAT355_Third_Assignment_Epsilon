...
import flowchart.diagram.edit.policies.InputItemSemanticEditPolicy;
...
public class InputEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputTextEditPart) {
			((InputTextEditPart) childEditPart).setLabel(getPrimaryShape().getFigureInputLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(FlowchartVisualIDRegistry.getType(InputTextEditPart.VISUAL_ID));
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 0, 100, 255);
