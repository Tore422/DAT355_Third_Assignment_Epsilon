...
public class FlowchartBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(FlowchartVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = FlowchartElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = FlowchartDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			FlowchartDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateTransition_4001(Flowchart container, Node source, Node target) {
		...
		* @generated
		*/
		public boolean canExistTransition_4001(Flowchart container, Transition linkInstance, Node source, Node target) {
			return true;
		}
	}
