	...
	*/
	public void run(IAction action) {
		...
		try {
			...
			FlowchartDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + domainModelURI, ex); //$NON-NLS-1$
		}
		if (diagramRoot == null) {
		...
		Wizard wizard = new FlowchartNewDiagramFileWizard(domainModelURI, diagramRoot, editingDomain);
