		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof flowchart.diagram.navigator.FlowchartNavigatorItem
					...
					return ((flowchart.diagram.navigator.FlowchartNavigatorItem) adaptableObject).getView();
				}
				return null;
			}
	...
	public boolean equals(Object obj) {
		if (obj instanceof flowchart.diagram.navigator.FlowchartNavigatorItem) {
			return EcoreUtil.getURI(getView())
					.equals(EcoreUtil.getURI(((flowchart.diagram.navigator.FlowchartNavigatorItem) obj).getView()));
		}
