...
public class FlowchartNavigatorLinkHelper implements ILinkHelper {
	...
	*/
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = FlowchartDiagramEditorPlugin.getInstance().getDocumentProvider()
	...
	*/
	public void activateEditor(IWorkbenchPage aPage, IStructuredSelection aSelection) {
		...
		if (abstractNavigatorItem instanceof FlowchartNavigatorItem) {
			navigatorView = ((FlowchartNavigatorItem) abstractNavigatorItem).getView();
			...
			if (navigatorGroup.getParent() instanceof FlowchartNavigatorItem) {
				navigatorView = ((FlowchartNavigatorItem) navigatorGroup.getParent()).getView();
