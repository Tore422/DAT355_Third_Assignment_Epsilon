 ...
 * @generated
 */
public class FlowchartNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case FlowchartEditPart.VISUAL_ID: {
			...
			FlowchartNavigatorGroup links = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Flowchart_1000_links, "icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(EventEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(AssignmentEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(DecisionEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(InputEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(OutputEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case EventEditPart.VISUAL_ID: {
			...
			FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Event_2001_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Event_2001_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
		...
		case AssignmentEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Assignment_2002_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Assignment_2002_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case DecisionEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Decision_2003_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Decision_2003_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case InputEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Input_2004_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Input_2004_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
		...
		case OutputEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			FlowchartNavigatorGroup incominglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Output_2005_incominglinks, "icons/incomingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			FlowchartNavigatorGroup outgoinglinks = new FlowchartNavigatorGroup(
					Messages.NavigatorGroupName_Output_2005_outgoinglinks, "icons/outgoingLinksNavigatorGroup.gif", //$NON-NLS-1$
					parentElement);
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					FlowchartVisualIDRegistry.getType(TransitionEditPart.VISUAL_ID));
	...
	*/
	 ...
	 * @generated
	 */
	private Collection<FlowchartNavigatorItem> createNavigatorItems(Collection<View> views, Object parent,
			boolean isLeafs) {
		ArrayList<FlowchartNavigatorItem> result = new ArrayList<FlowchartNavigatorItem>(views.size());
		for (View nextView : views) {
	 ...
	 * @generated
	 */
	private Collection<FlowchartNavigatorItem> getForeignShortcuts(Diagram diagram, Object parent) {
		LinkedList<View> result = new LinkedList<View>();
