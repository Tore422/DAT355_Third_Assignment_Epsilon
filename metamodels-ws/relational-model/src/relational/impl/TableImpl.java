 ...
 *   <li>{@link relational.impl.TableImpl#getConstraints <em>Constraints</em>}</li>
...
public class TableImpl extends NamedElementImpl implements Table {
	 ...
	 * @ordered
	 */
	protected PrimaryKeyConstraint primaryKey;
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentWithInverseEList<Constraint>(Constraint.class, this, RelationalPackage.TABLE__CONSTRAINTS, RelationalPackage.CONSTRAINT__BELONGING_TABLE);
		}
		return constraints;
	}
	...
	public PrimaryKeyConstraint getPrimaryKey() {
		if (primaryKey != null && primaryKey.eIsProxy()) {
			...
			primaryKey = (PrimaryKeyConstraint)eResolveProxy(oldPrimaryKey);
	 ...
	 * @generated
	 */
	public PrimaryKeyConstraint basicGetPrimaryKey() {
		return primaryKey;
	}
	 ...
	 * @generated
	 */
	public void setPrimaryKey(PrimaryKeyConstraint newPrimaryKey) {
		PrimaryKeyConstraint oldPrimaryKey = primaryKey;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case RelationalPackage.TABLE__CONSTRAINTS:
				...
				return;
			case RelationalPackage.TABLE__PRIMARY_KEY:
				setPrimaryKey((PrimaryKeyConstraint)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case RelationalPackage.TABLE__CONSTRAINTS:
				...
				return;
			case RelationalPackage.TABLE__PRIMARY_KEY:
				setPrimaryKey((PrimaryKeyConstraint)null);
				return;
		}
