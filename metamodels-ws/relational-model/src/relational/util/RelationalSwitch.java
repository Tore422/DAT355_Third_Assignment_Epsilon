...
public class RelationalSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RelationalPackage.NAMED_ELEMENT: {
			...
			case RelationalPackage.COLUMN_TYPE: {
			...
			case RelationalPackage.FOREIGN_KEY_CONSTRAINT: {
				...
				if (result == null) result = caseNamedElement(foreignKeyConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalPackage.ABSTRACT_UNIQUE_CONSTRAINT: {
				AbstractUniqueConstraint abstractUniqueConstraint = (AbstractUniqueConstraint)theEObject;
				T result = caseAbstractUniqueConstraint(abstractUniqueConstraint);
				if (result == null) result = caseConstraint(abstractUniqueConstraint);
				if (result == null) result = caseNamedElement(abstractUniqueConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalPackage.UNIQUE_CONSTRAINT: {
				...
				if (result == null) result = caseAbstractUniqueConstraint(uniqueConstraint);
				if (result == null) result = caseConstraint(uniqueConstraint);
				if (result == null) result = caseNamedElement(uniqueConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RelationalPackage.PRIMARY_KEY_CONSTRAINT: {
				...
				if (result == null) result = caseAbstractUniqueConstraint(primaryKeyConstraint);
				if (result == null) result = caseConstraint(primaryKeyConstraint);
				if (result == null) result = caseNamedElement(primaryKeyConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Unique Constraint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Unique Constraint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractUniqueConstraint(AbstractUniqueConstraint object) {
		return null;
	}
